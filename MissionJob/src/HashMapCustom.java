...
class HashMapCustom<K, V> {
    ...
    public static void main(String[] args) {
        ...
        hashMapCustom.put(38, 23);
        hashMapCustom.put(1, 7);
        hashMapCustom.put(99, 67);
        hashMapCustom.put(18, 8);
        hashMapCustom.put(16, 80);
        hashMapCustom.put(67, 9);

        System.out.println("value corresponding to key 21="
                + hashMapCustom.get(33));
